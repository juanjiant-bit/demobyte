...
//   - Philips I2S real
//   - slots de 32 bits por canal
//   - muestra de 16 bits alineada a la izquierda dentro del slot
//   - delay obligatorio de 1 bit entre transición de LRCK y primer bit de datos
